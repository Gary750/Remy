...
class _ClassDetailScreenState extends State<ClassDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      for (var student in studentsData) {
        ...
        final grade =
            hasSubmission ? await _getStudentGrade(studentId) : 0.0;
        final submissionDate =
            hasSubmission ? submission['created_at'] : null;
  ...
  Future<Map<String, dynamic>?> _getStudentSubmission(
  ...
  int _countByStatus(String status) {
    return _students.where((s) => s['status'] == status).length;
  }
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Banner entrega activa / sin entrega
                                ...
                                children: [
                                  ...
                                  ...filteredStudents.map((student) {
                                    ...
                                    final matricula =
                                        student['matricula'];
                                    final calificacion =
                                        student['calificacion'] as double;
                                    final statusColor =
                                        _getStatusColor(status);
                                    final statusIcon =
                                        _getStatusMaterialIcon(status);
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        // Navega al historial completo del alumno
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) =>
